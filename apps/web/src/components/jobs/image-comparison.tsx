  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <SectionCard>
        ...
        <img src={props.originalUrl} alt="Original upload" className="h-105 w-full rounded-2xl object-cover" />
      </SectionCard>
      <SectionCard>
        <p className="mb-4 text-sm uppercase tracking-[0.2em] text-(--muted)">Processed</p>
        {props.processedUrl ? (
          <img src={props.processedUrl} alt="Processed result" className="h-105 w-full rounded-2xl object-cover" />
        ) : (
